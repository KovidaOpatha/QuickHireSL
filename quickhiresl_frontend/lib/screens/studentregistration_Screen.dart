...
class StudentRegistrationScreen extends StatefulWidget {
  ...
  const StudentRegistrationScreen({Key? key, required this.role}) : super(key: key);
...
<<<<<<< HEAD
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const JobCategoriesScreen()));
                  }
                },
